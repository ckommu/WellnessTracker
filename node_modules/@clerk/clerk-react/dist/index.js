...
__export(src_exports, {
  ...
  __experimental_GoogleOneTap: () => __experimental_GoogleOneTap,
  useAuth: () => useAuth,
...
var versionSelector = (clerkJSVersion, packageVersion = "5.0.6") => {
  if (clerkJSVersion) {
...
var Portal = class extends import_react9.default.PureComponent {
  ...
  render() {
    var _a, _b;
    return /* @__PURE__ */ import_react9.default.createElement(import_react9.default.Fragment, null, /* @__PURE__ */ import_react9.default.createElement("div", { ref: this.portalRef }), (_b = (_a = this.props) == null ? void 0 : _a.customPagesPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react9.createElement)(portal, { key: index })));
  }
};
