...
interface Clerk {
     ...
     */
    __experimental_handleGoogleOneTapCallback: (signInOrUp: SignInResource | SignUpResource, params: HandleOAuthCallbackParams, customNavigate?: (to: string) => Promise<unknown>) => Promise<unknown>;
    /**
...
type OneTapProps = OneTapRedirectUrlProps & {
    /**
...
interface __experimental_AuthenticateWithGoogleOneTapParams {
    token: string;
}
